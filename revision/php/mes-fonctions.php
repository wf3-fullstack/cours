...
// GESTION DU UPDATE NOUS OBLIGE A GERER 
// UN 2E PARAMETRE $obligatoire=true OU =false
function filtrerUpload($nameInput, $obligatoire=true)
{
    $cheminFichierUpload = "";
    ...
    if (isset($_FILES[$nameInput])) {
        ...
        {
            if ($error != 0) {
                $tabErreur[] = "erreur pendant l'upload ($error)";
            }
        }
