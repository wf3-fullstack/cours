...
<body>
    ...
    <main>
        ...
        <section class="create">
            ...
            <form action="" method="POST">
                ...
                <button type="submit">PUBLIER UN content_user</button>
        ...
        <section class="sectionContentUserUpdate">
            ...
            <form class="formContentUserUpdate" action="" method="POST">
                ...
                <button type="submit">MODIFIER UN content_user</button>
                <input type="hidden" name="identifiantFormulaire" value="content_userUpdate">
            </form>
        </section>


        <section>
            <h2>READ SUR LA TABLE SQL content_user</h2>
            <table class="content_userList">
                <tbody>
                    <?php
                    // CODE PHP POUR RECUPERER LES LIGNES DE LA TABLE SQL content
                    // READ
                    $objetModel = new Model;
                    $tabResultat = $objetModel->lireTableSQL("content_user", "ORDER BY id DESC");
    ...
    <tr class="tr-$id">
        ...
        <td>$id_content</td>
        <td>$id_user</td>
        <td><button class="update" data-table="content_user" 
                    data-id="$id" data-id_content="$id_content" data-id_user="$id_user">modifier</button></td>
        <td><button class="delete" data-table="content_user" data-id="$id">supprimer</button></td>
    </tr>
CODEHTML;
                    }
                    ?>
        ...
        <section>
            <h2>READ SUR LA TABLE SQL user</h2>
            <table class="userList">
                <tbody>
                    ...
                    // READ
                    $objetModel = new Model;
                    $tabResultat = $objetModel->lireTableSQL("user", "ORDER BY id DESC");
                    foreach ($tabResultat as $tabLigne) {
